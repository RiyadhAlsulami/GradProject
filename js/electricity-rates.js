...
/**
 * Calculate the appropriate electricity rate based on consumption
 * @param {number} kwhUsage - Monthly kWh usage
 * @returns {number} - Rate in SAR per kWh
 */
...
/**
 * Calculate the total cost for a given kWh usage
 * @param {number} kwhUsage - Monthly kWh usage
 * @returns {number} - Total cost in SAR
 */
